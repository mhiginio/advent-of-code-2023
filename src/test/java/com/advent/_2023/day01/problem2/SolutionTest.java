package com.advent._2023.day01.problem2;
...
class SolutionTest {
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day01.problem2.SolutionTest#calibrationParams")
    ...
    public void should_compute_correct_value_for_provided_data() {
        assertEquals(54265,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day01/input.txt"))));
    }
