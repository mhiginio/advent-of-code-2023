package com.advent._2023.day11.problem2;

import com.advent._2023.InputParser;
import com.advent._2023.StringParser;
import com.advent._2023.day11.problem2.Solution;
...
class SolutionTest {
    ...
    void provided_data_should_return_569052586852() {
        assertEquals(569052586852L,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day11/input.txt"))));
    }
}