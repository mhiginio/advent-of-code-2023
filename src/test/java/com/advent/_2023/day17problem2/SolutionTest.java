package com.advent._2023.day17problem2;

import com.advent._2023.InputParser;
import com.advent._2023.StringParser;
import com.advent._2023.day17problem1.Solution;
...
class SolutionTest {
    ...
    void provided_data_should_return_825() {
        assertEquals(825,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day17problem1/input.txt"))));
    }
}