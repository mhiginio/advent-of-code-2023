...
import com.advent._2023.day05.problem2.Solution;
...
class SolutionTest {
    ...
    @Test
    void provided_data_should_return_17729182() {
        assertEquals(17729182,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day05problem2/input.txt"))));
    }
}