package com.advent._2023.day19problem2;
...
class SolutionTest {
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day19problem2.SolutionTest#rangeSizeData")
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day19problem2.SolutionTest#testData")
    ...
    void provided_data_should_return_116738260946855() {
        assertEquals(116738260946855L,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day19problem1/input.txt"))));
    }
}