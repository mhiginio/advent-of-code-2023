package com.advent._2023.day14problem2;
...
public class Solution {
    ...
    public long solution(Parser parser) {
        ...
        // Warm up:
        IntStream.range(0, 1000).forEach(k -> distribution.cycle());
        // Collect data to detect cycles:
        List<Long> sample = IntStream.range(0, 1000).mapToLong(k -> {
            distribution.cycle();
        ...
        // 1000000000 - length * n <19000 --> 1000000000 - 19000 < length * n --> n > (1000000000 - 19000) / length
        // We know all the values from 10000th to 19999th elements
        int value = (1000000000 - 1900) / length;
        int index = 1000000000 - (length * value);
        index -= 1000; // The initial warm up
