package com.advent._2023.day12.problem1;
...
class SolutionTest {
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day12.problem1.SolutionTest#conditionReportData")
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day12.problem1.SolutionTest#computeCombinationsData")
    ...
    @ParameterizedTest
    @MethodSource("com.advent._2023.day12.problem1.SolutionTest#getQuestionMarksData")
    ...
    void provided_data_should_return_7204() {
        assertEquals(7204L,
                solution.solution(new InputParser(getClass().getResourceAsStream("/day12/input.txt"))));
    }
}